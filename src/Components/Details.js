...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            method: "GET",
            url: `http://localhost:4545/restaurant/${restaurant}`,
    ...
    GetMenuItems = () => {
        ...
        axios({
            method: "GET",
            url: `http://localhost:4545/menuitems/${restaurantId}`,
            headers: { "Content-type": "application/json" },
        })
            .then((response) => {
    ...
    getData = (data) => {
        return fetch(`http://localhost:4545/payment`, {
            method: "POST",
            headers: {
    ...
    render() {
        ...
        return (
            <div>
                <div>
                    <img src={`./${restaurant.image}`} alt="No photo Found" width="100%" height="350px" />
                            ...
                            >
                                ...
                                {restaurant && restaurant.thumb && restaurant.thumb.map(item => {
                                    return <div className="car_img">
                                        <img height="350px" width="100%" className="carl_img"
                                            src={`./${item}`} />
                                    </div>
                                })}
                            </Carousel>
